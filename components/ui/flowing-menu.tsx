...
const MenuItem: React.FC<MenuItemProps> = ({ link, text, image }) => {
  ...
  return (
    ...
    >
      <a
        className="flex items-center justify-start h-full relative cursor-pointer uppercase no-underline font-semibold text-black text-[4vh] hover:text-[#060606] focus:text-black focus-visible:text-[#060606]"
        href={link}
